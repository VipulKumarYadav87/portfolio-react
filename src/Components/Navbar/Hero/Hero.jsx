...
import vipulphoto from "../../../assets/vipulphoto.jpeg";
import AnchorLink from 'react-anchor-link-smooth-scroll';
const Hero = () => {
  return (
    <div id='home' className='hero'>
      <img src={vipulphoto} alt="" />
      <h1>
  <span>I'm Vipul Kumar Yadav</span><br />
  Application Developer & MEAN/MERN FULL STACK DEVELOPER.
</h1>
